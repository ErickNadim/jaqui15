...
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"05_SOPA_DE_LETRAS_resources/media/i1_perro.jpg","");
...
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"05_SOPA_DE_LETRAS_resources/media/i2_gallo.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
$("#idDiv2").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"05_SOPA_DE_LETRAS_resources/media/i3_elefante.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
$("#idDiv3").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"05_SOPA_DE_LETRAS_resources/media/i4_ara__a.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
$("#idDiv4").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"05_SOPA_DE_LETRAS_resources/media/i5_mur.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
$("#idDiv5").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"05_SOPA_DE_LETRAS_resources/media/i6_oveja.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
$("#idDiv6").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"05_SOPA_DE_LETRAS_resources/media/i7_pinguino.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
$("#idDiv7").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"05_SOPA_DE_LETRAS_resources/media/i8_buho.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
$("#idDiv8").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"05_SOPA_DE_LETRAS_resources/media/i9_mariposa.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
$("#idDiv9").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"05_SOPA_DE_LETRAS_resources/media/i10_abeja.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
$("#idDiv10").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"05_SOPA_DE_LETRAS_resources/media/i11_leon.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
$("#idDiv11").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"05_SOPA_DE_LETRAS_resources/media/i12_gallina.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
$("#idDiv12").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"05_SOPA_DE_LETRAS_resources/media/i13_rana.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
}
